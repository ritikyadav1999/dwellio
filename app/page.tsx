...
import { NeighbourhoodSection, PropertyCard, featuredProperties } from "@/src/Homepage";
...
function HostContactSection() {
  ...
  return (
    <section
      id="host"
      className="bg-surface-container-low py-24 sm:py-32"
      aria-label="Become a host"
    >
      <div className="dwellio-container">
        <div className="grid gap-16 lg:grid-cols-[1fr_0.9fr] lg:items-center">
          <div>
            <p className="dwellio-label mb-4 text-on-surface-variant">Become a host</p>
            <h2 className="font-heading text-4xl font-normal leading-tight text-primary sm:text-5xl lg:text-6xl">
          ...
          <div className="relative">
            <div className="relative aspect-[4/5] overflow-hidden rounded-2xl dwellio-soft-shadow">
              <Image
